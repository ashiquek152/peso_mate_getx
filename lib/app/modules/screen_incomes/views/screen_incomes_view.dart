...
class ScreenIncomesView extends GetView<ScreenIncomesController> {
  ScreenIncomesView({Key? key}) : super(key: key);
                ...
                children: [
                 ...
                 Obx(()=> ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return dataAtindex.type=="Income"? Obx(()=>filterExpenseandIncome(
                          dataAtindex,
