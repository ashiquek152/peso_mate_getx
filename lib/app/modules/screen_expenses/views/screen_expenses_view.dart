...
class ScreenExpensesView extends GetView<ScreenExpensesController> {
   ScreenExpensesView({Key? key}) : super(key: key);
                ...
                children: [
                 ...
                 Obx(()=> ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return dataAtindex.type=="Expense"? Obx(()=>filterExpenseandIncome(
                          dataAtindex,
